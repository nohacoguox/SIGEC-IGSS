...
export const APP_SCREENS: AppScreenDefinition[] = [
  ...
  },
  {
    ...
    label: 'Revisión Dirección Departamental',
    panel: 'colaborador',
    description: 'Revisión y aprobación final SIAF por Dirección Departamental',
  },
  {
  ...
  },
  {
    ...
    panel: 'colaborador',
    group: 'Estadísticas',
    description: 'Estadísticas de tiempos de revisión, autorización y corrección',
  },
  {
    key: 'estadisticas-motivos',
    permission: 'estadisticas-motivos',
    label: 'Motivos de rechazo',
    panel: 'colaborador',
    group: 'Estadísticas',
    description: 'Estadísticas de motivos de rechazo SIAF',
  },
  {
    key: 'crear-expediente',
    permission: 'crear-expediente',
    label: 'Creación de Expediente',
    panel: 'colaborador',
  ...
  },
  {
    ...
    label: 'Revisión Expedientes (DD)',
    panel: 'colaborador',
    description: 'Revisar, aprobar o rechazar expedientes en Dirección Departamental',
  },
];
